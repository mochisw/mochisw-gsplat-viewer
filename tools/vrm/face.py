...
BASE = {
    "brow":     dict(cx=0.041, cz=1.5520, rx=0.025, rz=0.0060, rot=0.10, curve=0.004, offset=0.0030),
    "lash":     dict(cx=0.041, cz=1.5230, rx=0.034, rz=0.0110, rot=0.0, curve=0.006, offset=0.0038),
    "eyeWhite": dict(cx=0.041, cz=1.4900, rx=0.0305, rz=0.0300, rot=0.0, curve=0.0, offset=0.0022),
    "iris":     dict(cx=0.041, cz=1.4885, rx=0.0225, rz=0.0270, rot=0.0, curve=0.0, offset=0.0032),
    "blush":    dict(cx=0.056, cz=1.4535, rx=0.0165, rz=0.0105, rot=0.0, curve=0.0, offset=0.0026),
    "mouth":    dict(cx=0.0, cz=1.424, rx=0.021, rz=0.0035, rot=0.0, curve=0.002, offset=0.0022),
}

# 左右に分かれるパーツと、中央のパーツ。
SIDED = ["brow", "lash", "eyeWhite", "iris", "blush"]
CENTERED = ["mouth"]
...
EXPRESSIONS = {
    ...
    "surprised": {
        ...
        "eyeWhite": dict(rx=0.033, rz=0.034),
        "iris": dict(rx=0.0245, rz=0.0300),
